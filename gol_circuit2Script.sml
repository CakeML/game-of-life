...
Definition gate_def:
  gate (width:num) (height:num)
    (ins: ((int # int) # value) list)
    (outs: ((int # int) # value) list)
    (init: bool list list) ⇔ (ARB:bool)
End

Theorem gate_and_en_e:
  gate 1 1 [((-1,0),a); ((0,1),b)]
    [((1,0), v_and (v_delay 5 a) (v_delay 5 b))]
    and_en_e_concrete
Proof
  cheat
QED
...
Definition translate_def:
  translate (x:int,y:int) (init: bool list list) (a,b) ⇔ (ARB:bool)
End

Definition floodfill_def:
  floodfill (area: (int # int) list) (* set *)
    (outs: ((int # int) # value) list) (* multiset *)
    (crosses: ((int # int) # (int # int)) list)
    (init: (int # int) set) ⇔ (ARB:bool)
End
...
Theorem floodfill_add_small_gate:
  ...
  ¬MEM (x,y) area ∧
  PERM outs (del ++ outs') ∧
  LIST_REL (λ((a,b),P) (p, Q). p = (x+a,y+b) ∧ P ⊑ Q) ins1 del ⇒
  floodfill area (MAP (λ((a,b),Q). ((x+a,y+b),Q)) outs1 ++ outs') crosses
    (translate (x,y) init1 ∪ init)
Proof
  cheat
QED
...
Definition crossover_def:
  crossover
    (i1: int # int) (o1: int # int)
    (i2: int # int) (o2: int # int)
    (init: bool list list) ⇔ (ARB:bool)
End

Theorem floodfill_add_crossover:
  floodfill area outs crosses init ∧
  crossover (a,b) (a',b') i2 o2 init1 ∧
  ¬MEM (x,y) area ∧
  PERM outs (((x+a,y+b),P) :: outs') ∧
  v_delay 5 P ⊑ Q ⇒
  floodfill area (((x+a',y+b'),Q) :: outs') ((i2, o2) :: crosses)
    (translate (x,y) init1 ∪ init)
Proof
  cheat
QED
...
Theorem floodfill_finish_crossover:
  floodfill area outs crosses init ∧
  PERM outs ((p,P) :: outs') ∧
  PERM crosses ((p,q) :: crosses') ∧
  v_delay 5 P ⊑ Q ⇒
  floodfill area ((q,Q) :: outs') crosses' init
Proof
  cheat
QED
